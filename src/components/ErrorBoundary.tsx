    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen flex items-center justify-center bg-[#FAF9F6] px-4">
          <div className="max-w-md w-full text-center bg-white rounded-2xl border border-[#E8E5DE] shadow-sm p-8">
            <div className="w-14 h-14 rounded-full bg-rose-50 text-rose-600 flex items-center justify-center mx-auto mb-5">
              <AlertTriangle className="w-7 h-7" />
            </div>
            <h1 className="font-serif text-2xl font-bold text-[#1C1B19] mb-2">
              Something Went Wrong
            </h1>
            <p className="text-xs sm:text-sm text-[#6B6864] mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <button
                ...
                className="px-6 py-3 bg-[#1C1B19] hover:bg-[#2A2927] text-white text-xs font-bold uppercase tracking-[0.2em] rounded-lg flex items-center justify-center gap-2 cursor-pointer transition"
              >
